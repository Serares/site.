...
var listaLuni1 = document.querySelector('#lista');
var listaFood = document.getElementById('lista1');
var listaFood1 = document.querySelector('#lista1');
...
// }
// function dropFood(){
//     document.getElementById('lista1').classList.toggle('show1');
// }
    ...
    // trebuie sa inchida butonul produselor cand apesi pe oricealtceva din afara butonului, pune display none pe lista 
    


    // imagine.onclick = function(event){
