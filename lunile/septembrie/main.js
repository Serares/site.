...
// functie sa dispara lista de dropdown cand apesi in afara lui;
    ...
    // trebuie sa inchida butonul produselor cand apasi pe oricealtceva din afara butonului, pune display none pe lista 
    ...
    if(month === "ianuarie" || month ==="februarie" || month ==="decembrie"){
        ...
        imagine.style.backgroundImage = "url(../style/img/vara1.jpg)";
